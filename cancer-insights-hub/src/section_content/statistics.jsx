...
const StatisticsContent = () => {
  const statistics_cards = [
    ...
    },
    {
      ...
      description: `2009-2015: The 5-year relative survival rate for all cancers combined  wasd 67% overall, 68% in whites, and 62% in Blacks.`,
